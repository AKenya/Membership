...
Public Class CompletionDocuments
    ...
    Public Sub New(ByVal session As Session)
        MyBase.New(session)
    End Sub
    Private fDocumentType As DSCDocument
    Protected fMemberNumber As StudentManager
    <Association("StudentMgr-CompletionDocuments")> _
    Public Property MemberNumber() As StudentManager
        ...
        End Set
    End Property
    Public Property DocumentType() As DSCDocument
        Get
            Return fDocumentType
        End Get
        Set(ByVal value As DSCDocument)
    ...
    Public Overrides Sub AfterConstruction()
        ...
        fDocumentType = DSCDocument.Unknown
