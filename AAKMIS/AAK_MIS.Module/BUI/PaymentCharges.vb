...
Public Class PaymentCharges
    Inherits BaseObject
    Private fCRate, fARate As Double
    Public Sub New(ByVal session As Session)
        MyBase.New(session)
    End Sub
    <RuleRequiredField()> _
    Public Property ClientRate() As Double
        Get
            Return fCRate
        End Get
        Set(ByVal value As Double)
            SetPropertyValue("ClientRate", fCRate, value)
        End Set
    End Property
    <RuleRequiredField()> _
    Public Property ApplicantRate() As Double
        Get
            Return fARate
        End Get
        Set(ByVal value As Double)
            SetPropertyValue("ApplicantRate", fARate, value)
        End Set
    End Property
    ...
    ByVal oldValue As Object, ByVal newValue As Object)
        ...
        If propertyName = "ClientRate" Or propertyName = "ApplicantRate" Then
            UpdateModifiedOn()
        End If
    End Sub
