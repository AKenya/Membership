...
Public Class RescueTeam
    Inherits BaseObject
    Private fName, fIDNumber, fPinNumber, fCellNo, fEmail As String
    ...
    Public Property Branch() As Branch
        ...
        End Set
    End Property
    Private _IsRescueDriver As Boolean
    <VisibleInListView(False)> _
    Public Property IsRescueDriver() As Boolean
        Get
            Return _IsRescueDriver
        End Get
        Set(ByVal value As Boolean)
            SetPropertyValue("IsRescueDriver", _IsRescueDriver, value)
        End Set
    End Property
    Private _IsRescueAssistant As Boolean
    <VisibleInListView(False)> _
    Public Property IsRescueAssistant() As Boolean
        Get
            Return _IsRescueAssistant
        End Get
        Set(ByVal value As Boolean)
            SetPropertyValue("IsRescueAssistant", _IsRescueAssistant, value)
        End Set
    End Property
    Private _IsPatrolMan As Boolean
    <VisibleInListView(False)> _
    Public Property IsPatrolMan() As Boolean
        Get
            Return _IsPatrolMan
        End Get
        Set(ByVal value As Boolean)
            SetPropertyValue("IsPatrolMan", _IsPatrolMan, value)
        End Set
    End Property
    ...
    ByVal oldValue As Object, ByVal newValue As Object)
        ...
        If propertyName = "Name" Or propertyName = "CellNo" Or propertyName = "IDNumber" Then
            UpdateModifiedOn()
        End If
    End Sub
