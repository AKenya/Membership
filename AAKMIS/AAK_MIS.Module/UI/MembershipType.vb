...
Public Class MembershipType
    ...
    Public Property TypeName() As String
        ...
        Set(ByVal value As String)
            SetPropertyValue("TypeName", fTypeName, value)
        End Set
    End Property

    <Association("IndividualRegistration-MembershipType", GetType(MemberRegistration))> _
    Public ReadOnly Members() As MemberRegistration
    '<Association("Corporate-MembershipType", GetType(CorporateStem))> _
    'Public ReadOnly Corporates() As CorporateStem
    <Association("MembershipType-To-MemberCategory")> _
    Public ReadOnly Property Category() As XPCollection(Of MemberCategory)
        Get
            Return (GetCollection(Of MemberCategory)("Category"))
        End Get
    End Property
